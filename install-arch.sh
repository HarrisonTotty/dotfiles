...
packages="arandr autoconf base dunst emacs feh gcc git i3-gaps i3lock intel-ucode make neofetch openssh patch python-pywal rofi rxvt-unicode scrot sudo xclip xorg-server xorg-xinit xorg-xset zsh"
